...
export default async function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Background gradient with playful green tones */}
        <div
          style={{
            position: "absolute",
            top: 0,
        ...
        {/* Playful bubble pattern overlay */}
        <div
          style={{
            position: "absolute",
            top: 0,
            ...
            bottom: 0,
            backgroundImage:
              "radial-gradient(circle at 15% 25%, rgba(255, 255, 255, 0.15) 0%, transparent 30%), radial-gradient(circle at 85% 75%, rgba(255, 255, 255, 0.12) 0%, transparent 25%), radial-gradient(circle at 70% 15%, rgba(255, 255, 255, 0.08) 0%, transparent 35%)",
          }}
        />
        ...
        >
          {/* Avatar with fart bubble effect */}
          <div
            style={{
              display: "flex",
              alignItems: "center",
          ...
          {/* Fun tagline and Farcaster branding */}
          <div
            style={{
              display: "flex",
              flexDirection: "column",
          ...
          >
            ...
            >
              Playful pranks for your Farcaster friends
            </div>
